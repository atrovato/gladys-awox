...
module.exports = function (peripheral, characteristics, meshName = 'unpaired', meshPassword = '1234') {
  ...
  return awoxSend(peripheral, characteristics.get(meshShared.characteristics.pair), pairCommand, true).then(() => {
    return awoxSend(peripheral, characteristics.get(meshShared.characteristics.status), [0x01], true);
  }).then(() => {
